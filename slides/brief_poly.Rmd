...
# Polynomials from degree 0 to 5
...
# Weighted sums of polynomials: Example 1

```{r}
rpolynomial_examples(110)
```

# Weighted sums of polynomials: Example 2

```{r}
rpolynomial_examples(114)
```

# Weighted sums of polynomials: Example 3

```{r}
rpolynomial_examples(116)
```

# Weighted sums of polynomials: Example 4
...
* Polynomial of a specified degree can be performed as follows:
```{r, echo=T, eval=F}
y ~ x + I(x^2) + I(x^3)
```
but much easier as follows:
```{r, echo=T, eval=F}
